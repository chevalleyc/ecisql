...
import com.ethercis.graphql.datatypes.datavalue.DvDateQLType;
 ...
 */
public class DvDateGetEcisRM extends DvDateQLType {

    public DvDateGetEcisRM(I_RmObjectQLRegistry rmObjectQLType) {
    ...
    DataFetcher value = new DataFetcher() {
        ...
        public String get(DataFetchingEnvironment dataFetchingEnvironment) {
            return ((DvDate) dataFetchingEnvironment.getSource()).getValue();
        }
    };
