...
import com.ethercis.graphql.composition.interfaces.EntryQLIF;
 ...
 */
public class EntryIFGetEcisRM extends EntryQLIF {

    public EntryIFGetEcisRM(I_RmObjectQLRegistry rmObjectQLType) {
