 ...
 */
package com.ethercis.graphql.util;

import com.ethercis.ehr.building.util.*;
...
//        PartyRef partyRef = new PartyRef(new HierObjectID("ref"), CompositionAttributesHelper.DEMOGRAPHIC, CompositionAttributesHelper.PARTY);
        PartyRef partyRef = new PartyRef(new GenericID("123456-123", "ETHERCIS-SCHEME"),"ETHERCIS-NAMESPACE", com.ethercis.ehr.building.util.CompositionAttributesHelper.PARTY);
        ...
        return new EventContext(healthcareFacility, new DvDateTime(timenow.toString()), null, null, "TEST LAB", concept, null, terminologyService);
    }

    public static EventContext createNullContext() throws Exception {
        PartyRef partyRef = new PartyRef(new HierObjectID("ref"), "ETHERCIS-NAMESPACE", "null");
...
//        DateTime timenow = DateTime.now();
        ...
        TerminologyService terminologyService = TerminologyServiceWrapper.getInstance();
        return new EventContext(healthcareFacility, new DvDateTime(new DateTime(0L).toString()), null, null, null, concept, null, terminologyService);
    }
}
