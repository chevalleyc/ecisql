 ...
 */
public class DvTemporalQLType extends EcisQLType {

    private final String id = I_RmObjectQLRegistry.DV_TEMPORAL;

    protected DvTemporalQLType(I_RmObjectQLRegistry rmObjectQLType) {
    ...
    public GraphQLObjectType objectType() {
        GraphQLObjectType objectType = newObject()
                ...
                .withInterface(rmObjectType.interfaceType(I_RmObjectQLRegistry.DV_TEMPORAL))
                .build();
        return objectType;
    }
