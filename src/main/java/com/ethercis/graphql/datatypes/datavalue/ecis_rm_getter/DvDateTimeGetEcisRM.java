...
import com.ethercis.graphql.datatypes.datavalue.DvDateTimeQLType;
 ...
 */
public class DvDateTimeGetEcisRM extends DvDateTimeQLType {

    public DvDateTimeGetEcisRM(I_RmObjectQLRegistry rmObjectQLType) {
    ...
    DataFetcher value = new DataFetcher() {
        ...
        public String get(DataFetchingEnvironment dataFetchingEnvironment) {
            return ((DvDateTime) dataFetchingEnvironment.getSource()).getValue();
        }
    };
