...
import com.ethercis.graphql.datatypes.datavalue.DvBooleanQLType;
 ...
 */
public class DvBooleanGetEcisRM extends DvBooleanQLType {

    public DvBooleanGetEcisRM(I_RmObjectQLRegistry rmObjectQLType) {
    ...
    DataFetcher value = new DataFetcher() {
        ...
        public Boolean get(DataFetchingEnvironment dataFetchingEnvironment) {
            return ((DvBoolean) dataFetchingEnvironment.getSource()).getValue();
        }
    };
